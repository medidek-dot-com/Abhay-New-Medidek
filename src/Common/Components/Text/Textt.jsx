...
export const P3 = memo(({content = '', className=''}) => {
    return (
        <p className={`font-f2 font-w2 leading-[22.5px] text-[13px] text-c16 ${className}`}>{content}</p>
    )
});

export const Span = memo(({content = '', className=''}) => {
    return (
        <p className={`text-c4 font-f3 font-w1 leading-[15.6px] text-[13px]  ${className}`}>{content}</p>
    )
});
...
export const P5 = memo(({content = '', className='', onclick}) => {
    ...
    return (
        <p onClick={onclick} className={`font-f3 font-w2 leading-[15.6px] text-[0.813rem] text-c14 ${className}`}>{content}</p>
    )
});

export const P6 = memo(({content = '', className=''}) => {
    return (
        <p onClick={onclick} className={`font-f3 font-[400] leading-[18.6px] text-[0.825rem] text-c16 ${className}`}>{content}</p>
    )
});

export const FormLable = memo(({content = '', className='', htmlFor=''}) => {
    return (
...
export const FormSpan = memo(({content = '', className='', onclick}) => {
    return (
        <span onClick={onclick} className={`font-f3 font-w1 leading-[15.6px] text-[0.813rem] text-c3 cursor-pointer ${className}`}>{content}</span>
    )
});
export const ErrorSpan = memo(({content = '', className=''}) => {
    return (
        <span onClick={onclick} className={`font-f3 font-[400] leading-[12px] text-[0.825rem] text-c24 ${className}`}>{content}</span>
    )
});

export const LinkText = memo(({content = '', className='', to, onclick}) => {
    return (
        <Link to={to} onClick={onclick} className={`font-f2 font-w1 leading-[15.89px] text-[0.825rem] ${className}`}>{content}</Link>
    )
});
export const LinkTextWithIcon = memo(({content = '', className='', to, onclick, children}) => {
    return (
        <Link to={to} onClick={onclick} className={`font-f3 font-w1 leading-[15.89px] text-[0.813rem] ${className}`}>{content}{children}</Link>
    )
});

export const TextButton = memo(({content = '', className='', onclick}) => {
    return (
        <button onClick={onclick} className={`font-f2 font-w1 leading-[15.89px] text-[0.813rem] text-c16 ${className}`}>{content}</button>
    )
});
