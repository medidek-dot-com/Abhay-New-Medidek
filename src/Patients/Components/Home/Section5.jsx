...
import { H2 } from "../../../Common/Components/Text/Text";
        ...
        <section className="overflow-x-hidden md:mt-0 relative px-[16px] py-0 md:py-[112.5px] md:px-[50px] w-full min-h-[calc(100vh-108px)] flex flex-col items-center gap-[50px] md:gap-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-y-2 md:gap-[15px] ">
                <div className="col-span-3 row-span-3">
                    <img src="/Home/blog1.jpg" alt="img" className="w-full h-[205px] md:h-[501px] rounded-[6px]" />
                </div>
                <div className="w-full grid grid-cols-1 md:grid-cols-2 col-span-2 row-span-2 gap-[15px]">
                    <img src="/Home/blog1.jpg" alt="img" className="w-full md:w-[339px] h-[244px] rounded-[6px]" />
                    <img src="/Home/blog2.jpg" alt="img" className="w-full md:w-[339px] h-[244px] rounded-[6px]" />
                    <img src="/Home/blog3.jpg" alt="img" className="w-full md:w-[339px] h-[244px] rounded-[6px]" />
                    <img src="/Home/blog4.jpg" alt="img" className="w-full md:w-[339px] h-[244px] rounded-[6px]" />
                </div>
            </div>
            <PrimaryButton  className={"bg-c1 w-[171px] mb-4"}
                    h={"45px"}
                    bg={"c1"}
                    color={"white"}
                    radius={"44px"}
